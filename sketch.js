...
function preload()
{
  wal=loadAnimation("wa1.png","wa2.png","wa3.png","wa4.png","wa5.png","wa6.png"
  ,"wa7.png","wa8.png","wa9.png","wa10.png","wa 11.png","wa12.png",
  "wa13.png")

  clo=loadImage("sky.png")
  wat=loadImage("water.png")
  bac=loadImage("backdrop.png")
  gr=loadImage("grass.png")
  gra=loadImage("grass-1.png")

  co=loadAnimation("Coin_1.png","Coin_2.png","Coin_3.png","Coin_4.png")
  spi=loadImage("spikes.png")
